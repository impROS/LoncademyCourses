 ...
 * Testleri:  http://localhost:8896/<bolum>/<kod>-test.html  (önerilen)
...
/* Bu kursun kendi portu. Sabit 8899 bırakılırsa aynı anda açık başka bir
 * kurs setiyle çakışır ve sunucu EADDRINUSE ile hiç açılmaz. */
const PORT = Number(process.env.SKOR_PORT || 8896);
...
function hedefDosya(s) {
  ...
  if (u && (u.protocol === 'http:' || u.protocol === 'https:')) {
    ...
    // "başka bir kursa ait" diye reddedilir — sunucunun kendi önerdiği
    // açılış biçimi çalışmaz hâle gelirdi.
