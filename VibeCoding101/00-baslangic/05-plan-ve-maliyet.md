...
> **Süre:** ~15 dakika
> **Test:** yok — ölçme alışkanlığı **401 · *Maliyet*** konusunda test edilecek
...
| 🟡 **Belki** | Günde 2+ saat ajanla çalışıyorsan üst abonelik | Ama **ölçtükten sonra** — **401 · *Maliyet*** bunu öğretiyor |
| ⛔ **Alma** | "Vibe coding kursu / mentorluk" paketleri | Bu setin **401 · *Kaynaklar ve repolar*** konusu bedava ve güncel kaynakları veriyor |
...
kullandığını gösterir. **401 · *Maliyet*** bunu ekip ölçeğine taşıyor.
...
- "Prompt paketi", "vibe coding kursu" satın alma; **401 · *Kaynaklar ve repolar*** bedava kaynakları veriyor.

---

## Sırada ne var
➡️ [`../01-ajanla-calismak/1.1-ajan-dongusu.md`](../01-ajanla-calismak/1.1-ajan-dongusu.md) —
