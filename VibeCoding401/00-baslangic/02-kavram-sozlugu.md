...
→ [2.4](../02-uretim-ve-ekip/2.4-maliyet-yonetimi.md)
...
→ [00.4 Ayar rehberi](03-ayar-rehberi.md#düşünme-ve-model)
...
→ [2.1](../02-uretim-ve-ekip/2.1-guvenlik.md)
...
→ [2.2](../02-uretim-ve-ekip/2.2-gizlilik-ve-veri.md)
...
→ [2.3](../02-uretim-ve-ekip/2.3-lisans-ve-telif.md)
...
Adından ne olduğu anlaşılmayanlar. Ayrıntılı karşılaştırma: [1.1](../01-arac-haritasi/1.1-arac-haritasi.md).
...
> aracın kendi belgesine bak; `1.2` kararı nasıl vereceğini öğretiyor,
