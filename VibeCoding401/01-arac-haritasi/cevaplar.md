...
| Eksen | Bölüm |
|---|---|
| Bağlam yönetimi | **101 · *Bağlam penceresi*** |
| Yönlendirme katmanları | `02`, **301 · *Hook*** |
| Genişletilebilirlik | `04` |
| İzin modeli | **101 · *İzinler ve plan modu*** |
| Otomasyon | **301 · *Otomasyon ve SDK*** |
| Doğrulama desteği | **101 · *Doğrulama refleksi*** |
| Maliyet modeli | `2.4` |
| Veri işleme | `2.2` |
...
işinde, kendi kod tabanında yapılır (`1.2`).

🔗 [1.1 §4](1.1-arac-haritasi.md)
...
Bu yüzden `1.1`'in pratiği bir tablo doldurtuyor ve `1.2` o tabloyla karar
verdiriyor.
...
## 1.2 Hangisi ne zaman

### Soru 1 — Karar tablosu tek başına neden yetmez?

**Kısa cevap:** Çünkü tablo bir **başlangıç noktası**. Yanına `1.1`'de
...
Kurulum maliyeti gerçek: **101 · *AGENTS.md*** konusundaki kural geçerli — **talimat taşınır,
...
Bu, **301 · *Hook*** konusundaki hook coşkusuna karşı dengeleyici bir uyarı: hook harika bir
...
🔗 [1.2 §4](1.2-hangisi-ne-zaman.md)

---

## 1.3 Kaynaklar ve repolar
...
🔗 [1.3 §1 ve §2](1.3-kaynaklar-ve-repolar.md)
...
🔗 [1.3 §1 ve §4](1.3-kaynaklar-ve-repolar.md)
...
🔗 [1.3 §3](1.3-kaynaklar-ve-repolar.md)
...
gelmez. Kurmadan önce **301 · *Eklenti ve paylaşım*** konusundaki **dört soruyu** sorarsın:
...
🔗 [1.3 §2](1.3-kaynaklar-ve-repolar.md) · **301 · *Eklenti ve paylaşım***
...
**Kısa cevap:**
**Hızlı eskir:** araç adları ve özellikleri (`1.1`) · komut ve bayrak biçimleri
(**301 · *Otomasyon ve SDK***) · sürüm damgaları (**301 · *MCP ile bağlanmak***) · fiyat ve plan bilgileri (**101 · *Plan ve maliyet***).
**Yavaş eskir:** bağlam yönetimi (**101 · *Bağlam penceresi***) · doğrulama refleksi (**101 · *Doğrulama refleksi***) · iş
akışları (`03`) · güvenlik ilkeleri (`2.1`).
...
🔗 [1.3 §5](1.3-kaynaklar-ve-repolar.md)
