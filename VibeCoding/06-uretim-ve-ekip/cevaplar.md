...
🔗 [6.1 §1](6.1-guvenlik.md) · [4.5](../04-kendi-aletini-yap/4.5-mcp-sunucusu-yazma.md)
...
🔗 [6.1 §4](6.1-guvenlik.md)

---

## 6.2 Gizlilik ve veri
...
🔗 [6.3 §1 ve §4](6.3-lisans-ve-telif.md)
...
**Kısa cevap:**
1. **İnceleme dikkati** — inceleyen kişi `3.5`'teki beş kontrolü açar (`3.6`).
2. **Dürüstlük** — kaynağı gizlemek sonradan güven kaybettirir (`3.6`).
3. **Sonradan denetlenebilirlik** — bir lisans sorusu çıktığında hangi kodun
   nasıl üretildiğini bilmek (`6.3`).
...
maliyet hem kalite açısından doğru (`1.3`).
...
**Ayrıntı:** `5.2`'deki dörtlü burada da geçerli: **tur sayısı · düzeltme
...
Üçüncü karar (`6.1`'e bağlanır): geri dönülemez ve dışa dönük eylemler asla
...
**Ayrıntı:** Araç kararı `5.2`'nin konusu ve farklı bir çerçeveyle verilir:
...
daha kesin, hızlı ve ucuzdur — ve **sessiz sapma** riski taşımaz (`3.7`).

🔗 [6.6 §4](6.6-sinirlar.md)
...
Bu, `00.1`'deki ayrımın son hâli: vibe coding **tabanı** yükseltir, ajan
